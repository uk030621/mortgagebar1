...
const handleBarClick = (index) => {
  ...
  return (
    <div>
      <a className='hyperlink1' href="https://djapbarchart1.vercel.app/" target = "_blank" rel="noopener noreferrer"style={{ color: 'rgba(75, 192, 192, 1)' }}>Link to Advisor Protection Tracking</a>
